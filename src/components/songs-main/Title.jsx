...
const Title = () => {
  return (
    ...
    >
      <h2 className="text-xs font-semibold mt-16 sm:mt-[3rem]">PLAYLIST</h2>
      <h1 className="text-[4.5rem] sm:text-[2.5rem] font-bold tracking-[-1px] leading-[2rem] sm:leading-[3rem] md:leading-[4rem] lg:leading-[5rem] mt-12 sm:mt-[0] ml-[-4px]">
        Hot Hits Vietnam
      </h1>
